// lib/wick-brain-server.js — Wick's persona, tools, and context-building,
// shared by api/wick-chat.js and api/wick-memory.js. Lives outside api/ —
// not itself a route, and Vercel (on this project, no framework detected)
// counts every file under api/ toward the Hobby plan's 12-function cap
// regardless of underscore-prefixed subfolders, which is what actually
// broke the previous api/_lib/ placement. Ported from
